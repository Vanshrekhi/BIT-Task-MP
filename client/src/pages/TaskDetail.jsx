...
const formatTaskStatus = (stage = "") => {
  const s = String(stage).toLowerCase();
  if (s === "todo") return "Assigned";
                ...
                <div className='flex items-center gap-5'>
                  ...
                  <div className={clsx("flex items-center gap-2")}>
                    ...
                    <span className='text-black uppercase'>
                      {task?.stage === "todo" ? "assigned" : task?.stage}
                    </span>
                  </div>
                  <button
                    type='button'
                    className={clsx(
                      ...
                      STATUS_STYLES[task?.stage] || "bg-gray-100 text-gray-700 border-gray-200"
                    )}
                  >
                    Current Status: {formatTaskStatus(task?.stage)}
                  </button>
                </div>
